...
const style = {
  ...
  ethLogo: `h-5 mr-2`,
  accent: `text-[#2081e2] w-1/2 text-base flex items-center break-words inline-block my-auto ml-[10px]`,
...
export const UserItem: React.FC<any> = ({ user }) => {
  ...
  return (
    <div className={style.eventItem}>
      ...
      <div className="text-[#2081e2] w-1/2 md:w-1/6 text-base flex items-center">
        <img
